      ...
      <main style={{ maxWidth: 960, margin: "0 auto", padding: "0 24px 96px" }}>
        <section style={{ textAlign: "center", padding: "88px 0 64px" }}>
          ...
          <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" }}>
            <a href="#pricing" style={{ padding: "14px 28px", borderRadius: 999, background: "linear-gradient(135deg,#b8922a 0%,#d4af37 50%,#b8922a 100%)", color: "#0a1a0e", boxShadow: "0 6px 22px rgba(212,175,55,.22)" }}>Start 3-Day Free Trial</a>
